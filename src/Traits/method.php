...
trait method
{
     ...
     * @return returnedMessage
     */
    public function sendMessage($chat_id, string $text, string $parse_mode = 'html', bool $disable_web_page_preview = false, $reply_markup = null, bool $disable_notification = null, int $reply_to_message_id = null, $entities = null, $allow_sending_without_reply = null)
    {
        return returnedMessage::create($this->bot('sendMessage', compact('chat_id', 'text', 'parse_mode', 'disable_web_page_preview', 'reply_markup', 'disable_notification', 'reply_to_message_id', 'entities', 'allow_sending_without_reply')));
    }

    /**
     * @return returnedMessage
     */
    public function forwardMessage($chat_id, $from_chat_id, int $message_id, bool $disable_notification = false)
    {
        return returnedMessage::create($this->bot('forwardMessage', compact('chat_id', 'from_chat_id', 'disable_notification', 'message_id')));
    }

    /**
     * @return returnedMessage
     */
    public function copyMessage($chat_id, $from_chat_id, int $message_id, $caption = null, $parse_mode = 'html', $reply_markup = null, bool $disable_notification = false, $reply_to_message_id = null, $allow_sending_without_reply = true)
    {
        return returnedMessage::create($this->bot('copyMessage', compact('chat_id', 'from_chat_id', 'disable_notification', 'message_id', 'reply_markup', 'caption ', 'parse_mode', 'reply_to_message_id', 'allow_sending_without_reply')));
    }

    /**
     * @return returnedMessage
     */
    public function sendPhoto($chat_id, $photo, string $caption = null, string $parse_mode = 'html', bool $disable_notification = false, array $reply_markup = null, int $reply_to_message_id = null, $caption_entities = [], $allow_sending_without_reply = true)
    {
        return returnedMessage::create($this->bot('sendPhoto', compact('chat_id', 'photo', 'caption', 'parse_mode', 'reply_to_message_id', 'disable_notification', 'reply_markup', 'caption_entities', 'allow_sending_without_reply')));
    }

    /**
     * @return returnedMessage
     */
    public function sendAudio($chat_id, string $audio, string $caption = null, array $reply_markup = null, string $performer = null, string $title = null, int $duration = null, string $thumb = null, bool $disable_notification = false, int $reply_to_message_id = null, $caption_entities = [], $allow_sending_without_reply = true)
    {
        return returnedMessage::create($this->bot('sendAudio', compact('chat_id', 'audio', 'caption', 'duration', 'performer', 'title', 'thumb', 'disable_notification', 'reply_to_message_id', 'reply_markup', 'caption_entities', 'allow_sending_without_reply')));
    }

    /**
     * @return returnedMessage
     */
    public function sendDocument($chat_id, $document, string $caption = null, bool $disable_notification = false, array $reply_markup = null, string $thumb = null, int $reply_to_message_id = null, string $parse_mode = 'html', $caption_entities = [], $allow_sending_without_reply = true)
    {
        return returnedMessage::create($this->bot('sendDocument', compact('chat_id', 'document', 'thumb', 'parse_mode', 'caption', 'disable_notification', 'reply_to_message_id', 'reply_markup', 'caption_entities', 'allow_sending_without_reply')));
    }

    /**
     * @return returnedMessage
     */
    public function sendVideo($chat_id, string $video, string $caption = null, array $reply_markup = null, bool $disable_notification = false, int $reply_to_message_id = null, int $duration = null, int $width = null, int $height = null, string $thumb = null, string $parse_mode = 'html', bool $supports_streaming = true, $caption_entities = [], $allow_sending_without_reply = true)
    {
        return returnedMessage::create($this->bot('sendVideo', compact('chat_id', 'video', 'caption', 'duration', 'disable_notification', 'width', 'height', 'reply_to_message_id', 'reply_markup', 'thumb', 'parse_mode', 'supports_streaming', 'caption_entities', 'allow_sending_without_reply')));
    }

    /**
     * @return returnedMessage
     */
    public function sendAnimation($chat_id, string $animation, int $duration = null, int $width = null, int $height = null, string $thumb = null, string $caption = null, bool $disable_notification = true, int $reply_to_message_id = null, array $reply_markup = null, $caption_entities = [], $allow_sending_without_reply = true)
    {
        return returnedMessage::create($this->bot('sendAnimation', compact('chat_id', 'animation', 'caption', 'duration', 'disable_notification', 'width', 'height', 'reply_to_message_id', 'reply_markup', 'thumb', 'caption_entities', 'allow_sending_without_reply')));
    }

    /**
     * @return returnedMessage
     */
    public function sendVoice($chat_id, string $voice, string $caption = null, string $parse_mode = 'html', bool $disable_notification = true, array $reply_markup = null, int $reply_to_message_id = null, int $duration = null, $caption_entities = [], $allow_sending_without_reply = true)
    {
        return returnedMessage::create($this->bot('sendVoice', compact('chat_id', 'voice', 'caption', 'parse_mode', 'duration', 'disable_notification', 'reply_to_message_id', 'reply_markup', 'caption_entities', 'allow_sending_without_reply')));
    }

    /**
     * @return returnedMessage
     */
    public function sendVideoNote($chat_id, string $video_note, array $reply_markup = null, bool $disable_notification = true, int $reply_to_message_id = null, int $length = null, string $thumb = null, int $duration = null, $allow_sending_without_reply = true)
    {
        return returnedMessage::create($this->bot('sendVideoNote', compact('chat_id', 'video_note', 'duration', 'length', 'thumb', 'disable_notification', 'reply_to_message_id', 'reply_markup', 'allow_sending_without_reply')));
    }

    /**
     * @return returnedMessage
     */
    public function sendMediaGroup($chat_id, $media, bool $disable_notification = true, int $reply_to_message_id = null, $allow_sending_without_reply = true)
    {
        return returnedMessage::create($this->bot('sendMediaGroup', compact('chat_id', 'media', 'disable_notification', 'reply_to_message_id', 'allow_sending_without_reply')));
    }

    /**
     * @return returnedMessage
     */
    public function sendLocation($chat_id, float $latitude, float $longitude, int $live_period = null, array $reply_markup = null, bool $disable_notification = true, int $reply_to_message_id = null, $allow_sending_without_reply = true, $proximity_alert_radius = null, $heading = null, $horizontal_accuracy = null)
    {
        return returnedMessage::create($this->bot('sendLocation', compact('chat_id', 'latitude', 'longitude', 'live_period', 'disable_notification', 'reply_to_message_id', 'reply_markup', 'allow_sending_without_reply', 'proximity_alert_radius', 'heading', 'horizontal_accuracy')));
    }
     ...
     * @return returnedMessage
     */
    public function sendVenue($chat_id, $latitude, $longitude, $title, $address, $foursquare_id = null, $foursquare_type = null, $google_place_id = null, $google_place_type = null, array $reply_markup = null, $disable_notification = null, $reply_to_message_id = null, $allow_sending_without_reply = true)
    {
        return returnedMessage::create($this->bot('sendVenue', compact('chat_id', 'latitude', 'longitude', 'title', 'address', 'foursquare_id', 'foursquare_type', 'disable_notification', 'reply_to_message_id', 'reply_markup', 'google_place_id', 'google_place_type', 'allow_sending_without_reply')));
    }

    /**
     * @return returnedMessage
     */
    public function sendContact($chat_id, string $phone_number, string $first_name, string $last_name, string $vcard = null, bool $disable_notification = true, int $reply_to_message_id = null, array $reply_markup = null, $allow_sending_without_reply = true)
    {
        return $this->bot('sendContact', compact('chat_id', 'phone_number', 'first_name', 'last_name', 'vcard', 'disable_notification', 'reply_to_message_id', 'reply_markup', 'allow_sending_without_reply'));
    }

    /**
     * @return returnedMessage
     */
    public function sendPoll($chat_id, string $question, array $options, bool $is_anonymous = true, string $type = 'regular', bool $allows_multiple_answers = false, int $correct_option_id = null, $explanation = null, $explanation_parse_mode = null, $explanation_entities = [], $open_period = null, $close_date = null, bool $is_closed = null, bool $disable_notification = false, int $reply_to_message_id = null, $allow_sending_without_reply = true, array $reply_markup = null)
    {
        return returnedMessage::create($this->bot('sendPoll', compact('chat_id', 'question', 'options', 'is_anonymous', 'type', 'allows_multiple_answers', 'correct_option_id', 'is_closed', 'disable_notification', 'reply_to_message_id', 'reply_markup', 'explanation', 'explanation_parse_mode', 'explanation_entities', 'open_period', 'close_date', 'allow_sending_without_reply')));
    }

    /**
     * @return returnedMessage
     */
    public function sendDice($chat_id, $emoji = '🎲', bool $disable_notification = false, int $reply_to_message_id = null, array $reply_markup = null, $allow_sending_without_reply = true)
    {
        return returnedMessage::create($this->bot('sendDice', compact('chat_id', 'emoji', 'disable_notification', 'reply_to_message_id', 'reply_markup', 'allow_sending_without_reply')));
    }
    ...
    {
        return returnedArrayOfChatMember::create($this->bot('getChatAdministrators', compact('chat_id')));
    }
